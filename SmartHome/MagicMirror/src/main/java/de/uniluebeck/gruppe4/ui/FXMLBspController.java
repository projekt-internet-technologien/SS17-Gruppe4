...
public class FXMLBspController implements Initializable {
	...
	public boolean refresh_done = true;
	@Override
	public void initialize(URL location, ResourceBundle resources) {
		initialisiereAnzeigeDaten();

		init_done = true;
		Thread t = new Thread(new FXMLBspTask(this));
		t.start();
	}

	/**
	 * Berechnet und setzt die Breite fuer die mittlere Spalte. Die rechte und die
	 * linke Spalte haben jeweils eine fixe breite. Die mittlere Spalte soll den
	 * restlichen Platz auffuellen.
	 */
	...
	public void hideAll() {
		label_name.setOpacity(0);
		label_date.setOpacity(0);
		label_time.setOpacity(0);
		label_calendar.setOpacity(0);
		label_mensa.setOpacity(0);
		label_newsfeed_title.setOpacity(0);
		label_newsfeed_description.setOpacity(0);
		label_weather_actual_temp.setOpacity(0);
		label_weather_actual_hum.setOpacity(0);
		label_weather_forecast_1.setOpacity(0);
		label_weather_forecast_2.setOpacity(0);
		label_weather_forecast_3.setOpacity(0);
	}

	public void showAll() {
		label_name.setOpacity(1);
		label_date.setOpacity(1);
		label_time.setOpacity(1);
		label_calendar.setOpacity(1);
		label_mensa.setOpacity(1);
		label_newsfeed_title.setOpacity(1);
		label_newsfeed_description.setOpacity(1);
		label_weather_actual_temp.setOpacity(1);
		label_weather_actual_hum.setOpacity(1);
		label_weather_forecast_1.setOpacity(1);
		label_weather_forecast_2.setOpacity(1);
		label_weather_forecast_3.setOpacity(1);
	}
}
