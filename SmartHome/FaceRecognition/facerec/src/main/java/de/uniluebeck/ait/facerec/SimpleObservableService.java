...
public abstract class SimpleObservableService extends ObservableWebresource<Long>{

	private static Logger LOG = Logger.getLogger(SimpleObservableService.class.getName());
    
	public static long DEFAULT_CONTENT_FORMAT = ContentFormat.TEXT_PLAIN_UTF8;

	protected static HashMap<Long, String> payloadTemplates = new HashMap<>();
     ...
     */
    public SimpleObservableService(String path, int updateInterval, ScheduledExecutorService executor) {
